...
其中两种功能强大的工具是 objdump 和 readelf 程序,关于nm工具的参数说明及更多示例详见 [nm 目标文件格式分析](https://linuxtools-rst.readthedocs.io/zh_CN/latest/tool/nm.html#nm)
...
file用于查看文件的类型，比如我们在64位机器上发现一个32位的库，连接不上，这就有问题：
